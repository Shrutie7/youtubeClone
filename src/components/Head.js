  ...
  return (
    <div className="grid grid-flow-col p-3 m-1 shadow-lg">
      ...
      <div className=" col-span-10 ">
        ...
        {showsuggestions && suggestions.length>0  &&<div className="absolute mt-10 bg-white py-2 px-2 w-[43rem] rounded-lg border border-gray-100 z-[9999]">
          {suggestions&& suggestions.map((ele)=>(
           
            
            <div className="flex gap-3 text-lg py-1 px-3"> <img
          src={search}
          alt="search"
          className="h-4 my-2"
        />{ele}</div>
